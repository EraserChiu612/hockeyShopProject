            ...
            <div class="row">
                <div class="col-6">
                    <div class="card bg-dark text-white ">
                        <img src="../public/images/Rectangle 27.png" class="card-img" alt="...">
                        <div class="card-img-overlay stick">

                            <div class="row d-flex justify-content-center align-items-end">
                                <div class="col-4">
                                    <h5 class="card-title card-title-body">客製化球桿</h5>
                                    <p class="card-text card-title-text">客製化球桿部分<br>1.姓名&nbsp;2.號碼&nbsp;3.球隊&nbsp;4.LOGO
                                    </p>
                                </div>
                                <div class="col-2"></div>
                                <div class="col-4">
                            ...
                            <div class="card-img-overlay stick">
                                ...
                                <div class="row d-flex justify-content-center align-items-end">
                                    <div class="col-4">
                                        ...
                                        <p class="card-text card-title-text">客製化裝備部分<br>1.手套&nbsp;2.號碼&nbsp;3.球隊配色&nbsp;4.姓名
                                        </p>
                                    </div>
                                    <div class="col-2"></div>
                                    <div class="col-4">
                                        <a href=""
                                           class="btn btn-orange text-white card-title-btn ms-3">線上詢價</a>
                                    </div>
                                </div>
                            </div>
                        </div>
