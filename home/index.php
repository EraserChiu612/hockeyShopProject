...
<main>
	...
	<div class="banner">
		<div class="shop-now">
			...
			<p class="shop-now-p">
				The CANNON PRO Gives you the strongest power to scored from any where.
			</p>
	...
	<div class="emailsection mt-5">
		<div class="row">
			...
			<div class="col-6">
				...
				<form>
					<div class="mb-3">
						<input type="email" class="design w-50" id="exampleInputEmail1" aria-describedby="emailHelp" />
